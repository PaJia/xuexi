 ...
 */
public class MyJCRecyAdapter extends RecyclerView.Adapter<MyJCRecyAdapter.ViewHolder> {
    List<SY_JingCanBean.ListBean> list;
    Context context;

    public MyJCRecyAdapter(List<SY_JingCanBean.ListBean> list, Context context) {
        this.list = list;
