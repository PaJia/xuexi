...
public class ClassroomFragment extends BaseFragment<NetPresenter, NetModel> implements NetContract.View {
    ...
    private String mUrl = "http://mapi.univs.cn/mobile/index.php?app=mobile&type=mobile&controller=content&catid=3&page=1&action=index&time=0 ";
    ...
    protected void initBan() {
        ...
        mList.add("http://upload.univs.cn/2016/1122/1479797095206.png");
        mList.add("http://upload.univs.cn/2016/1114/thumb_640_314_1479103823901.jpg");
