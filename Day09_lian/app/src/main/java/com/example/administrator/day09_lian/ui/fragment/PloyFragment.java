 ...
 */
public class PloyFragment extends BaseFragment<NetPresenter, NetModel> implements NetContract.View {
    private Banner mBanner;
    private RecyclerView mRecy;
    private RecyclerViewHeader mHeader;
    ArrayList<String> mList = new ArrayList<>();
    private String mUrl = "http://mapi.univs.cn/mobile/index.php?app=mobile&type=mobile&controller=content&catid=12&page=1&action=index&time=0 ";
    private HeadlineAdapter headlineAdapter;

    @Override
    protected void initBan() {

        mList.add("http://upload.univs.cn/2017/1016/1508140343640.jpg");
        mList.add("http://upload.univs.cn/2017/1016/thumb_640_314_1508140373904.jpg");
        mList.add("http://upload.univs.cn/2017/0913/1505269223282.jpg");
