 ...
 */
public class HeadlineFragment extends BaseFragment<NetPresenter, NetModel> implements NetContract.View {
    private Banner mBanner;
    private RecyclerView mRecy;
    private RecyclerViewHeader mHeader;
    ArrayList<String> mList = new ArrayList<>();
    private String mUrl = "http://mapi.univs.cn/mobile/index.php?app=mobile&type=mobile&controller=content&catid=11&page=1&action=index&time=0";
