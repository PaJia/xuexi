 ...
 */
public class MainActiviyView extends GridView {
    //拖拽响应的时间 默认为1s
    ...
    public MainActiviyView(Context context) {
        this(context, null);
    }

    public MainActiviyView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MainActiviyView(Context context, AttributeSet attrs, int defStyleAttr) {
