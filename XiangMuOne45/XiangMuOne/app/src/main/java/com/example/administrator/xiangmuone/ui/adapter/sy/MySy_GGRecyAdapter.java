 ...
 */
public class MySy_GGRecyAdapter extends RecyclerView.Adapter<MySy_GGRecyAdapter.ViewHolder> implements View.OnClickListener {
    List<SY_GgspBean.ListBean> list;
    Context context;

    public MySy_GGRecyAdapter(List<SY_GgspBean.ListBean> list, Context context) {
        this.list = list;
