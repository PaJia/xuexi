 ...
 */
public class MySy_RecyAdapter extends RecyclerView.Adapter<MySy_RecyAdapter.ViewHolder> implements View.OnClickListener {
    List<ShouYeBean.DataBean.PandaliveBean.ListBean> list;
    Context context;

    public MySy_RecyAdapter(List<ShouYeBean.DataBean.PandaliveBean.ListBean> list, Context context) {
        this.list = list;
