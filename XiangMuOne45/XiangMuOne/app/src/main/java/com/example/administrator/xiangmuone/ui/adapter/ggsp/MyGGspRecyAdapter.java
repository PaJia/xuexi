package com.example.administrator.xiangmuone.ui.adapter.ggsp;
 ...
 */
public class MyGGspRecyAdapter extends RecyclerView.Adapter<MyGGspRecyAdapter.ViewHolder> implements View.OnClickListener {
    List<GGspBean.ListBean> list;
    Context context;

    public MyGGspRecyAdapter(List<GGspBean.ListBean> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.textView2.setText(list.get(position).getBrief());
